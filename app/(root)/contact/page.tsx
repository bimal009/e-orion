        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Have questions about E-ORION? We're here to help you get started
              with professional esports broadcasting.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Whether you're planning your first tournament or running a major
                esports event, our team is ready to help you succeed.
              </p>
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div
                    key={index}
                    className="flex gap-4 p-4 rounded-xl border border-border/50 /50"
                  >
