...
const PointTableCard = ({ pointTable, onEdit }: PointTableCardProps) => {
  ...
  return (
    <div
      ...
      onClick={() =>
        router.push(
          `/dashboard/tournment/${pointTable.tournamentId}/${pointTable.id}`
        )
      }
    >
      {/* Background Gradient */}
      ...
      <div className="relative z-10">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-background border border-border rounded-xl">
            ...
            <tbody>
              {Array.isArray(pointTable.ranks) &&
              pointTable.ranks.length > 0 ? (
