...
import { useDeleteTeam } from '../api/useTeams'
...
const TeamCard = ({ team, onEdit }: TeamCardProps) => {
    ...
    return (
      <div
        ...
        onClick={() => router.push(`/dashboard/tournment/${team.tournamentId}/teams/${team.id}`)}
      >
        {/* Background Gradient */}
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-accent rounded-xl border border-border">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium text-sm text-foreground">Players</span>
              </div>
