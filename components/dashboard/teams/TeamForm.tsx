  ...
  // import { useCreateTeams, useUpdateTeams } from '../api/useTeam'  
        ...
        <DialogContent className="sm:max-w-2xl max-w-[95vw] rounded-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              <span>{type === 'edit' ? 'Edit Team' : 'Create New Team'}</span>
            </DialogTitle>
            <DialogDescription>
              {type === 'edit' ? 'Update the details below to edit the team.' : 'Fill in the details below to create a new team.'}
            </DialogDescription>
          </DialogHeader>
